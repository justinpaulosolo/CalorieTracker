...
public class MealMacrosCalculator : IMealMacrosCalculator
{
    ...
    {
        return (foodEntry.Food.Proteins * foodEntry.Quantity, foodEntry.Food.Carbs * foodEntry.Quantity, foodEntry.Food.Fats * foodEntry.Quantity, foodEntry.Food.Calories * foodEntry.Quantity);
    }
}
