...
type CreateMealEntryFormValues = z.infer<typeof newEntryFormScheme>;

export default function CreateMealEntryForm() {
  const [currentDate] = useCurrentDate();
  const createMealEntry = useCreateMealEntry();
  const form = useForm<CreateMealEntryFormValues>({
  ...
  async function onSubmit(data: CreateMealEntryFormValues) {
