...
const FoodRow = ({ food, onDeleteClick }: {
  food: Food;
    ...
    <TableCell className="w-20">
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem onClick={() => onDeleteClick(food.foodDiaryEntryId)}
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="font-medium w-20 text-right">Protein</TableHead>
          ...
          <TableBody>
            {data?.foods && data.foods.map((food, index) => (
              <FoodRow key={index} food={food} onDeleteClick={handleOnDeleteClick} />
            ))}
          </TableBody>
        ...
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <Button variant="destructive" onClick={handleOnDeleteConfirm}>
              {isPending ? <Icons.spinner className="mr-2 h-4 w-4 animate-spin" /> : "Delete"}
            </Button>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
